...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_grasp_plugin_SOURCE_PREFIX /UR_ws/src/gazebo-pkgs/gazebo_grasp_plugin)
  set(gazebo_grasp_plugin_DEVEL_PREFIX /UR_ws/devel)
  ...
  set(gazebo_grasp_plugin_INSTALL_PREFIX /UR_ws/install)
...
if(NOT "/UR_ws/src/gazebo-pkgs/gazebo_grasp_plugin/include;/UR_ws/build/gazebo-pkgs/gazebo_grasp_plugin/.. " STREQUAL " ")
  set(gazebo_grasp_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/UR_ws/src/gazebo-pkgs/gazebo_grasp_plugin/include;/UR_ws/build/gazebo-pkgs/gazebo_grasp_plugin/..")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/UR_ws/src/gazebo-pkgs/gazebo_grasp_plugin/${idir}'.  ${_report}")
    endif()
