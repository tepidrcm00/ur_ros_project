...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/UR_ws/src/gazebo-pkgs/gazebo_world_plugin_loader/include".split(';') if "/UR_ws/src/gazebo-pkgs/gazebo_world_plugin_loader/include" != "" else []
