...
echo_and_run cd "/UR_ws/src/turtlebot3/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/UR_ws/src/turtlebot3/turtlebot3_example/setup.py" \
     \
    build --build-base "/UR_ws/build/turtlebot3/turtlebot3_example" \
    install \
    --root="${DESTDIR-/}" \
