...
echo_and_run cd "/UR_ws/src/turtlebot3_machine_learning/turtlebot3_dqn"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/UR_ws/src/turtlebot3_machine_learning/turtlebot3_dqn/setup.py" \
     \
    build --build-base "/UR_ws/build/turtlebot3_machine_learning/turtlebot3_dqn" \
    install \
    --root="${DESTDIR-/}" \
