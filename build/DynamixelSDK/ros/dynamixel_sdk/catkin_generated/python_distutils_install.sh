...
echo_and_run cd "/UR_ws/src/DynamixelSDK/ros/dynamixel_sdk"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/UR_ws/src/DynamixelSDK/ros/dynamixel_sdk/setup.py" \
     \
    build --build-base "/UR_ws/build/DynamixelSDK/ros/dynamixel_sdk" \
    install \
    --root="${DESTDIR-/}" \
